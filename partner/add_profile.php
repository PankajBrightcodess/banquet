        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger  ">
              ...
              <div class="row">
                   <div class="col-md-3">
                  <form role="form" action="#" id="form_data" method="post">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-12 mb-2">
                          <label>Company Name <span style="color:red;">*</span></label>
                          <input type="text" name="comp_name" id="name" class="form-control" required="" placeholder="Enter Company Name :">
                        </div>
                        
                         <div class="col-md-12 mb-2">
                          <label>Contact no.<span style="color:red;">*</span></label>
                          <input type="text" name="contact_no" id="contact_no" class="form-control" required="" placeholder="Enter Address :">
                        </div>
                         <div class="col-md-12 mb-2">
                          <label>Email<span style="color:red;">*</span></label>
                          <input type="email" name="email" id="email" class="form-control" required="" placeholder="Enter Address :">
                        </div>
                        <div class="col-md-12 mb-2">
                        ...
                        <div class="col-md-12 mb-2">
                          ...
                          <input type="text" name="land_mark" id="land_mark" class="form-control" required="" placeholder="Enter Land Mark :">
                        </div>
                         <div class="col-md-12 mb-2">
                          <label>Description.<span style="color:red;">*</span></label>
                          <input type="text" name="aadhar" id="aadhar" class="form-control" required="" placeholder="Enter Description :">
                        </div>
                        <div class="col-md-12 mb-2">
                          <label>Rate.<span style="color:red;">*</span></label>
                          <input type="text" name="rate" id="rate" class="form-control" required="" placeholder="Enter New Password :">
                        </div>
                         <div class="col-md-12 mb-2">
                          <label>Add Photo.<span style="color:red;">*</span></label>
                          <input type="text" name="photo[]" id="photo" class="form-control" required="" placeholder="Enter New Password :">
                        </div>
                        <div class="col-md-4">
      ...
      <div class="row">
        ...
        <div class="col-md-12 mb-2">
         ...
         <div class="col-md-12 mb-2">
          ...
          <input type="email" name="aadhar" id="aadhars" class="form-control" required="" placeholder="Enter Aadhar :">
        </div>
        <div class="col-md-12 mb-2">
          <label>Password.<span style="color:red;">*</span></label>
          <input type="email" name="password" id="passwords" class="form-control" required="" placeholder="Enter New Password :">
        </div>
